...
"Plugin to help write qt .qrc file"
...
nmap <silent> <Leader>w :CtrlP /home/giangdt15/study/<CR>
nmap <silent> <Leader>c :CtrlP /home/giangdt15/w/dauEmbedded/<CR>
nmap <silent> <Leader>s :CtrlP /home/giangdt15/w/h/s/<CR>
...
function! OpenOther()
   ...
   elseif expand("%:e") == "h"
      if findfile(expand("%:p:r:s?include?src?").".c", ".") == expand("%:p:r:s?include?src?").".c"
		...
		elseif findfile(expand("%:p:r:s?include?src?").".cpp", ".") == expand("%:p:r:s?include?src?").".cpp"
         "exe "write"
         exe "e" fnameescape(expand("%:p:r:s?include?src?").".cpp")
      else
         echo "there is not an appropriate .cpp or .c file"
      endif
...
set cscopetag
set csto=0
cscope add /home/giangdt15/.cscopeDatabase/libmodbus/cscope.out
cscope add /home/giangdt15/.cscopeDatabase/sddiApp/cscope.out
cscope add /home/giangdt15/.cscopeDatabase/dauEmbedded/cscope.out
cscope add /home/giangdt15/.cscopeDatabase/boost_1_55_0/cscope.out
"set cscopeverbose
...
function! GenerateCscopeDatabase()
   exe "!/home/giangdt15/.vim/cscopeGenerate.sh"
   exe "cs reset"
   "echo "Cscope change mode to Sensitive Case in searching"
endfunction
...
function! Sync2lub()
   exe "!/home/giangdt15/.vim/sync2lub.sh"
endfunction
